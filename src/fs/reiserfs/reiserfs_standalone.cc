...
int main(int argc, char *argv[]) 
{
  ...
  if (!strcmp(argv[1], "test")) {
    ...
    reiserfs_fuzzer.compress(in_path, image_buffer, meta_path);
    ...
    reiserfs_fuzzer.decompress(tmp_buffer, st.st_size, true);
    ...
    void *image_buffer = malloc(st.st_size);
    reiserfs_fuzzer.compress(in_path, image_buffer, "reiserfs_meta.img");
