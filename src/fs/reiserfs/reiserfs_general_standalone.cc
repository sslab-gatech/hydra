...
/* usage: 
   ./reiserfs_standalone test in_image out_image meta_image
...
int main(int argc, char *argv[]) 
{
  ...
  if (!strcmp(argv[1], "test")) {
    ...
    reiserfs_fuzzer.general_compress(in_path, image_buffer, meta_path);
    ...
    reiserfs_fuzzer.general_decompress(tmp_buffer, st.st_size, true);

    reiserfs_fuzzer.sync_to_file(out_path);
    ...
    void *image_buffer = malloc(st.st_size);
    reiserfs_fuzzer.general_compress(in_path, image_buffer, "meta.img");
