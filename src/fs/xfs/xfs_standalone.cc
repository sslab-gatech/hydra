...
int main(int argc, char *argv[]) 
{
  ...
  if (!strcmp(argv[1], "test")) {
    ...
    xfs_fuzzer.compress(in_path, image_buffer, meta_path);
    ...
    xfs_fuzzer.decompress(tmp_buffer, st.st_size, true);
    ...
    void *image_buffer = malloc(st.st_size);
    xfs_fuzzer.compress(in_path, image_buffer, "xfs_meta.img");
