...
int main(int argc, char *argv[]) 
{
  ...
  if (!strcmp(argv[1], "test")) {
    ...
    hfsplus_fuzzer.compress(in_path, image_buffer, meta_path);
    ...
    hfsplus_fuzzer.decompress(tmp_buffer, st.st_size, true);
    ...
    void *image_buffer = malloc(st.st_size);
    hfsplus_fuzzer.compress(in_path, image_buffer, "hfsplus_meta.img");
