...
int main(int argc, char *argv[]) 
{
  ...
  if (!strcmp(argv[1], "test")) {
    ...
    vfat_fuzzer.compress(in_path, image_buffer, meta_path);
    ...
    vfat_fuzzer.decompress(tmp_buffer, st.st_size, true);
    ...
    void *image_buffer = malloc(st.st_size);
    vfat_fuzzer.compress(in_path, image_buffer, "vfat_meta.img");
