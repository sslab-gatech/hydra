...
int main(int argc, char *argv[]) 
{
  ...
  if (!strcmp(argv[1], "test")) {
    ...
    gfs2_fuzzer.compress(in_path, image_buffer, meta_path);
    ...
    gfs2_fuzzer.decompress(tmp_buffer, st.st_size, true);
    ...
    void *image_buffer = malloc(st.st_size);
    gfs2_fuzzer.compress(in_path, image_buffer, "gfs2_meta.img");
