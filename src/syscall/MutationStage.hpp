...
// We don't care this quite a lot at the moment.
class ArgStage : public MutationStage {

    private:
        std::vector<SyscallMutator*>::iterator mutatingSyscall;
    public:
        ArgStage() = delete;
        ArgStage(uint8_t* seed, uint32_t len);
        ~ArgStage() { };
