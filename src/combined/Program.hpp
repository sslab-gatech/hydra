...
struct Program {
	...
	// first desrialize, remove some syscalls from the list and seriliaze
	static Program *selective_reserialize(const char *spath, const char *dpath,
